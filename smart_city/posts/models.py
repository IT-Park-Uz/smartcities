...
class News(models.Model):
    ...
    user_liked = models.ManyToManyField(User, related_name="user_liked_n", blank=True)
    saved_collections = models.ManyToManyField(User, related_name="user_saved_n", blank=True)
...
class Article(models.Model):
    ...
    description = RichTextUploadingField()
    view_count = models.IntegerField(default=0)
    user_liked = models.ManyToManyField(User, related_name="user_liked_a", blank=True)
    saved_collections = models.ManyToManyField(User, related_name="user_saved_a", blank=True)
    tags = models.ManyToManyField('Tags', blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    is_delete = models.BooleanField(default=False)
    is_active = models.BooleanField(default=False)
...
class Question(models.Model):
    ...
    description = RichTextUploadingField()
    view_count = models.IntegerField(default=0)
    user_liked = models.ManyToManyField(User, related_name="user_liked_q", blank=True)
    saved_collections = models.ManyToManyField(User, related_name="user_saved_q", blank=True)
    tags = models.ManyToManyField('Tags', blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
    is_delete = models.BooleanField(default=False)
    is_active = models.BooleanField(default=False)
...
class Theme(MPTTModel):
    ...
    preview_icon = models.FileField("Preview Icon", upload_to='Themes/%y/%m/%d', null=True, blank=True)
    created_at = models.DateTimeField(auto_now_add=True)
